...
from batch_sahi.sahi.utils.file import Path, increment_path, list_files, save_json, save_pickle, save_yolo, save_yolo_conf
    ...
    **kwargs,
    ...
    for ind, image_path in enumerate(
        ...
        if not no_sliced_prediction:
            ...
            prediction_result = get_sliced_prediction_batch(
                image=image_as_pil,
                detection_model=detection_model,
                slice_height=slice_height,
                slice_width=slice_width,
